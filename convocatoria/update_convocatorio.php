        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Actualizar Convocatoria</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Actualizacion Convocatorias</h3>
                    </div>
                    <?php
                    ...
                    <form class="form-horizontal"
                        action="<?php echo $URL; ?>controllers/controller_convocatorio/controller_update_convocatorio.php"
                        ...
                        <div class="card-body row">
                            <div class="col-md-6">
                                ...
                                <input type="text" value="<?php echo $id;?>"
                                    name="id_convoc" hidden>
                            </div>
                        </div>
                        <br>
                        <div class="card-footer">
                            <center><a href="<?php echo $URL;?>convocatoria/"
