            ...
            <section class="content">
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Actualizacion Eventos</h3>
                    </div>
                    <?php
                    ...
                    <form class="form-horizontal"
                        action="<?php echo $URL; ?>controllers/controller_evento/controller_update_evento.php"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control"
                                            ...
                                            required><?php echo $herramienta; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for=""
