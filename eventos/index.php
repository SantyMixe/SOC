            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado Eventos
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1"
                            ...
                            <?php
                            $contar_taller =0;
                              $consulta_talleres = $pdo->prepare("SELECT * FROM tema_taller WHERE estado = '1'");
                              ...
                              foreach ($talleres as $taller){
                                ...
                                $contar_taller = $contar_taller +1;
                                ?>

                            <tr>
                                <td>
                                    <center><?php echo $contar_taller;?>
                                    </center>
                                </td>
                                <td>
                                    <center>
                                ...
                                <td>
                                    <center><?php echo $nametallerista;?>
                                    </center>
                                </td>
                                <td>
                                    <center><?php echo $cupos;?> </center>
                                </td>
                                <td>
                                    <?php
                                        $caracter_buscar = ".";
