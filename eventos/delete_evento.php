        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Eliminar Eventos</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                ...
                <div class="card card-danger">
                    ...
                    <?php
                              ...
                              $consulta_talleres = $pdo->prepare("SELECT * FROM tema_taller WHERE id_taller = '$id_evento'");
                              $consulta_talleres->execute();
                              $talleres = $consulta_talleres->fetchAll(PDO::FETCH_ASSOC);
                              foreach ($talleres as $taller){
                                ...
                                $nametallerista = $taller['nombre_tallerista'];
                                $cupos = $taller['cupos'];
                                $horario_entrada = $taller['horario_entrada'];
                                $horario_salida = $taller['horario_salida'];
                                $herramienta = $taller['herramientas'];
                                $ubicacion = $taller['ubicacion'];
                                $poster = $taller['img_taller'];
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control"
                                        ...
                                        rows="3"
                                        value="<?php echo $herramienta; ?>"
                                        disabled><?php echo $herramienta; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for=""
                    ...
                    <div class="card-footer">
                        <center>
                            ...
                            <a href="<?php echo $URL;?>controllers/controller_evento/controller_delete_evento.php?id_taller=<?php echo $id;?>"
