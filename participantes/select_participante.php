        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Aprobar Participante</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                ...
                <div class="card card-warning">
                    ...
                    <form class="form-horizontal"
                        action="<?php echo $URL; ?>controllers/controller_participantes/controller_aprov_participante.php"
                        ...
                        <div class="card-footer">
                            <center><a href="<?php echo $URL;?>participantes/"
                                ...
                                <button type="submit"
                                    class="btn btn-success btn-lg">Aprobar
                                    Participante</button>
                            </center>
                        </div>
                </div>
