        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Registro Participante</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">Registro Participantes</h3>
                    </div>

                    <?php                          
                              $consulta_talleres = $pdo->prepare("SELECT * FROM tema_taller WHERE id_taller = '$id_participante'");
                    ...
                    <form class="form-horizontal"
                        action="<?php echo $URL; ?>controllers/controller_participantes/controller_create_particpante.php"
                        ...
                        <div class="card-body row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for=""
                                        class="col-sm-4 col-form-label">Fecha y
                        ...
                        <div class="card-footer">
                            <center><a href="<?php echo $URL;?>principal.php"
