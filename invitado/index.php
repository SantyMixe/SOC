            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Invitados Registrados
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1"
                            ...
                            <?php
                            $contar_invitado =0;
                              $consulta_invitado = $pdo->prepare("SELECT * FROM invitado WHERE estado = '1'");
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="select_invitado.php?id_invit=<?php echo $id; ?>"
                                            class="btn btn-success btn-sm"><span
                                                class="fa-solid fa-pen-to-square"></span>
                                            Seleccionar Invitado</a>
                                    </center>
                                </td>
                            </tr>
                            <?php
