...
$id_invitcancel = $_GET['id_invitcancel'];
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Cancelar Invitado</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                ...
                <div class="card card-danger">
                    ...
                    <?php
                            $consulta_invitado = $pdo->prepare("SELECT * FROM invitado WHERE id_invitado = '$id_invitcancel'");
                    ...
                    <div class="card-footer">
                        <center>
                            <a href="<?php echo $URL;?>invitado/invitado_aprob.php"
                                class="btn btn-lg btn-info">Regresar</a>
                            <a href="<?php echo $URL;?>controllers/controller_invitado/controller_cancel_invitado.php?id_invitcancel=<?php echo $id;?>"
