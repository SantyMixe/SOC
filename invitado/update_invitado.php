        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Actualizar Invitado</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
            ...
            <section class="content">
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title">¿Estas Seguro Actualizar el Dato
                            del
                            Invitado?</h3>
                    </div>
                    <?php
                    ...
                    <form class="form-horizontal"
                        action="<?php echo $URL; ?>controllers/controller_invitado/controller_update_invitado.php"
                        ...
                        <div class="card-footer">
                            <center><a href="<?php echo $URL;?>invitado/"
                                ...
                                <button type="submit"
                                    class="btn btn-success btn-lg">Actualizar
                                    Invitado</button>
                            </center>
                        </div>
                </div>
