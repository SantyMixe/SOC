            ...
            <section class="content">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado Usuarios
                        </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1"
                            ...
                            <?php
                            $contar_user =0;
                              $consulta_users = $pdo->prepare("SELECT * FROM tb_usuarios WHERE estado = '1'");
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <?php echo $nombre."  ".$apellido_p."  ".$apellido_m;?>
                                    </center>
                                </td>
                                <td>
                                ...
                                <td>
                                    <?php
                                        $caracter_buscar = ".";
                                        $buscar = strpos($foto_p,$caracter_buscar);
                                      if($buscar == true){
                                        //echo "Existe foto de perfil";
                                        ?>
                                    <center><img
                                            src="<?php echo $URL;?>controllers/img_perfil/<?php echo $foto_p;?>"
